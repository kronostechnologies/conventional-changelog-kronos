...
describe('kronos preset', function() {
  ...
  it('should work if there is no semver tag', function(done) {
    conventionalChangelogCore({
      ...
      .pipe(through(function(chunk) {
        ...
        expect(chunk).to.include(', closes [#1](https://github.com/kronostechnologies/conventional-changelog-kronos/issues/1) [#2](https://github.com/kronostechnologies/conventional-changelog-kronos/issues/2)');
  ...
  it('should replace #[0-9]+ with GitHub issue URL', function(done) {
    ...
    conventionalChangelogCore({
      ...
      .pipe(through(function(chunk) {
        chunk = chunk.toString();
        expect(chunk).to.include('[#133](https://github.com/kronostechnologies/conventional-changelog-kronos/issues/133)');
        done();
      }));
  });
